        ...
        <div class="main_body">
            ...
            <div class="container">
                <h2><span class="icon"><i class="fas fa-solid fa-paw"></i></span>
                    <span class="list">Lista de mascotas</span>
                </h2>
                <br>
                <?php
                                    ...
                                    <table class="tabla4">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="11%">Peso actual</th>
                                                <th width="25%">Dueño</th>
                                                <th width="10%">Historial médico</th>
                                                <th width="12%">Calendario (vacunas)</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($solicitudes as $solicitud) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $solicitud['Fecha_nac']; ?>
                                                    </td>

                                                    <td>
                                                        <?php echo $solicitud['Peso_actual']; ?>
                                                    </td>
                                                    <?php
                                                    $Dueño = $solicitud['Dueño'];
                                                    ...
                                                    ?>
                                                    <td>
                                                        <?php echo $NombreDueño ?>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="ver_historial.php?id_mascota=<?php echo $solicitud['id_mascota']; ?>"><i
                                                                class="fas fa-scroll x"></i></a>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="ver_vacunacion.php?id_mascota=<?php echo $solicitud['id_mascota']; ?>"><i
                                                                class="fas fa-calendar-check x"></i></a>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="ver_perfil_m.php?id_mascota=<?php echo $solicitud['id_mascota']; ?>"><i
                                                                class="fas fa-dog x"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
